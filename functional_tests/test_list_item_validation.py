...
from functional_tests.base import (wait_for_row_in_list_table,
                                   ...
                                   wait_until_presence_of_element_by_css_selector,
                                   wait_until_NOT_presence_of_element_by_css_selector)
...
class TestItemValidation:
    ...
    def test_cannot_add_empty_list_items(self, browser: webdriver.Chrome, live_server: fixtures.live_server):
        ...
        wait_until_presence_of_element_by_css_selector(browser, "#id_text:invalid")
        # Эдит начинает набирать текст нового элемента и ошибка исчезает
        get_item_input_box(browser).send_keys("Buy milk")
        wait_until_NOT_presence_of_element_by_css_selector(browser, "#id_text:invalid")
        wait_until_presence_of_element_by_css_selector(browser, "#id_text:valid")
