...
from functional_tests.base import wait_for_row_in_list_table, browser, get_item_input_box, add_list_item
...
class TestNewVisitor:
    ...
    def test_can_start_a_list_for_one_user(self, browser, live_server):
        ...
        add_list_item("Купить павлиньи перья", browser)
        # Когда она нажимает enter, страница обновляется, и теперь страница
        # содержит "1: Купить павлиньи перья" в качестве элемента списка
        # Текстовое поле по-прежнему приглашает ее добавить еще один элемент.
        # Она вводит "Сделать мушку из павлиньих перьев"
        add_list_item("Сделать мушку из павлиньих перьев", browser)
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self, browser, live_server):
        ...
        add_list_item("Купить молоко", browser)
